"""
Django settings for dogs_next_door_48620 project.
...
ROOT_URLCONF = 'dogs_next_door_48620.urls'
...
WSGI_APPLICATION = 'dogs_next_door_48620.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Dogs Next Door Support <support@dogs-next-door-48620.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dogs_next_door_48620 API",
    "DESCRIPTION": "API documentation for dogs_next_door_48620 App",
    "VERSION": "v1",
}
